...
namespace EthereumSmartContracts.Contracts.SimpleCollectible
{
    public partial class SimpleCollectibleService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, SimpleCollectibleDeployment simpleCollectibleDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<SimpleCollectibleDeployment>().SendRequestAndWaitForReceiptAsync(simpleCollectibleDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, SimpleCollectibleDeployment simpleCollectibleDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<SimpleCollectibleDeployment>().SendRequestAsync(simpleCollectibleDeployment);
        }

        public static async Task<SimpleCollectibleService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, SimpleCollectibleDeployment simpleCollectibleDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, simpleCollectibleDeployment, cancellationTokenSource);
            return new SimpleCollectibleService(web3, receipt.ContractAddress);
        }
        ...
        public SimpleCollectibleService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
        ...
        public Task<string> CreateCollectibleRequestAsync(CreateCollectibleFunction createCollectibleFunction)
        {
             return ContractHandler.SendRequestAsync(createCollectibleFunction);
        }

        public Task<TransactionReceipt> CreateCollectibleRequestAndWaitForReceiptAsync(CreateCollectibleFunction createCollectibleFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(createCollectibleFunction, cancellationToken);
        }

        public Task<string> CreateCollectibleRequestAsync(string tokenURI)
        {
            var createCollectibleFunction = new CreateCollectibleFunction();
                createCollectibleFunction.TokenURI = tokenURI;
            
             return ContractHandler.SendRequestAsync(createCollectibleFunction);
        }

        public Task<TransactionReceipt> CreateCollectibleRequestAndWaitForReceiptAsync(string tokenURI, CancellationTokenSource cancellationToken = null)
        {
            var createCollectibleFunction = new CreateCollectibleFunction();
                createCollectibleFunction.TokenURI = tokenURI;
        ...
        public Task<BigInteger> TokenCounterQueryAsync(TokenCounterFunction tokenCounterFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<TokenCounterFunction, BigInteger>(tokenCounterFunction, blockParameter);
        }

        
        public Task<BigInteger> TokenCounterQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<TokenCounterFunction, BigInteger>(null, blockParameter);
        }
